...
const finalMessage = document.getElementById('final-massage');
...
// Assignment instated off useing array [] find an API to replace it
...
// Functions to display the selectedword in the DOM
function displayWord() {
    ...
    // Replace new line character and fore inner word
...
// Function to show the notofocation
...
function updateIncorrectLetters() {
    ...
    figureParts.forEach((part, index) => {
        // How many incorrect letters has user guessed
...
// 2. Listen for click on the play again button
playBtn.addEventListener('click', () => {
    // Empty correct correctLettersArray and incorrectLettersArray

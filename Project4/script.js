...
// Event Listeners
// Recalculate Exechange Rate when Currency 1 Change
currencyOne.addEventListener('change', calculate);
// Recalculate exechange amount when currency 1 amount changes
amountCurrencyOne.addEventListener('input', calculate);
// Recalculate Exechange Rate when Currency 2 Change
currencyTwo.addEventListener('change', calculate);
// Recalculate exechange amount when currency 2 amount changes
